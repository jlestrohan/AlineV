...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C2_MspInit 0 */
    ...
    PA8     ------> I2C2_SDA 
    */
    GPIO_InitStruct.Pin = I2C2_CMPS12_SCL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_I2C2;
    HAL_GPIO_Init(I2C2_CMPS12_SCL_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = I2C2_CMPS12_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_I2C2;
    HAL_GPIO_Init(I2C2_CMPS12_SDA_GPIO_Port, &GPIO_InitStruct);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PA8     ------> I2C2_SDA 
    */
    HAL_GPIO_DeInit(I2C2_CMPS12_SCL_GPIO_Port, I2C2_CMPS12_SCL_Pin);

    HAL_GPIO_DeInit(I2C2_CMPS12_SDA_GPIO_Port, I2C2_CMPS12_SDA_Pin);
